...
if HF_TOKEN:
    ...
    logger.warning("No HUGGING_FACE_TOKEN found in environment variables")
    print("Warning: No HUGGING_FACE_TOKEN found. Set it to access gated models.")
...
# Global instance - MUST be after class definition
