...
# Import SAM3 callbacks if available
try:
    from callbacks.sam3_segmentation import *  # noqa: F403, F401
except ImportError:
    print("SAM3 callbacks not loaded - transformers/torch not available")
